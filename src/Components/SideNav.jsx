...
const SideNav = () => {
  return (
    <div
      style={{ position: "fixed", width: "249px", backgroundColor: "#181818",height:"100%" }}
    >
      ...
      >
        ...
        >
          ...
          >
            ...
            >
              <option style={{backgroundColor:"#0f382f" }}>Energy</option>
              <option style={{backgroundColor:"#0f382f"}}>Category 1</option>
              <option style={{backgroundColor:"#0f382f"}}>Category 4</option>
              <option style={{backgroundColor:"#0f382f"}}>Category 6</option>
              <option style={{backgroundColor:"#0f382f"}}>Category 7</option>
              <option style={{backgroundColor:"#0f382f"}}>Category 9</option>
            </select>
          </div>
          <div
            style={{
      ...
      <div style={{ width: "100%", padding: "63.5px 31px 63.5px 7px" }}>
        <button
          style={{
            width: "187px",
            height: "50px",
